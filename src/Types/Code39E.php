...
class Code39E implements BarcodeTypeInterface
{
    ...
    public function encode(string $data): Barcode
    {
        ...
        for ($i = 0; $i < $len; $i++) {
            ...
            if (!isset(self::$extended[$char])) {
                throw new \InvalidArgumentException("Invalid character for Code39E: $char");
            }
        ...
        return new Barcode('Code39E', $data, $bars, $width);
    }
